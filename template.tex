    ...
    \begin{onecolentry}
      \textbullet{} \textbf{Research Intern} QDX, Melbourne \hfill Feb - Jun 2025
        \begin{highlightsforbulletentries}
            \begin{highlightsforbulletentries}
              \item Implemented novel machine learning framework (Python, C++) for automatic recognition and deployment of collective variables in proprietary molecular dynamics suite
              \item 400\% speedup compared to tradition workflows, requiring minimal prior knowledge of the system under study
